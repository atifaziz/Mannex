...
namespace Mannex.Tests.Collections.Generic
{
    ...
    public class IEqualityComparerTests
    {
        ...
        {
            var equals = StringComparer.OrdinalIgnoreCase.EqualsFunc();
            Assert.True(equals("FOO", "foo"));
        }
        ...
        [Fact]
        public void GetHashCodeFunc()
        {
            var getHashCode = StringComparer.OrdinalIgnoreCase.GetHashCodeFunc();
            Assert.Equal(getHashCode("FOO"), getHashCode("foo"));
        }
    }
}